...
public class StubConnectionToClient extends Thread implements IConnectionToClient
{
	// INSTANCE VARIABLES ***********************************************
	...
	// CONSTRUCTORS *****************************************************
	   ...
	   *        the connection.
	   */
	  public StubConnectionToClient( IHandler client, StubEchoServer server) throws IOException
	  {
